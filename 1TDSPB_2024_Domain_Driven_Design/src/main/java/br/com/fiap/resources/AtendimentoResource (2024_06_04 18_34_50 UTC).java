...
private AtendimentoBO atendimentoBO = new AtendimentoBO();
	...
	@Path("{/idFuncionario}")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response alterarRs(Atendimento atendimento, @PathParam("idFuncionario") int idFuncionario) throws ClassNotFoundException, SQLException {
	...
	public Response deletarRs(@PathParam("idFuncionario") int idFuncionario) throws ClassNotFoundException, SQLException {
		atendimentoBO.deletarBo(idFuncionario);
		return Response.ok() .build();
	}
